 ...
 * from the environment variables OLLAMA_URL, OLLAMA_MODEL, AI_ENABLED, AI_TIMEOUT_MS and AI_WARM_UP.
 *
 ...
 * @param warmUp true = ask Ollama to load the model once the service has started (see {@link OllamaWarmUp})
 */
