...
/**
 * Declares the messaging topology used by shop-service:
 * <pre>
 *  airport.events (topic)  --flight.#-->  shop-service.flight-events
 *                                            | (rejected after 3 attempts)
 *                                            v
 *  airport.events.dlx (direct) --shop-service--> shop-service.dlq
 * </pre>
 */
@Configuration
