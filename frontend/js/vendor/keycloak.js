// Vendored copy of keycloak-js 26.2.4 (npm package "keycloak-js", file lib/keycloak.js), Apache-2.0 - see the
// licence header below. Keycloak 26 no longer serves the adapter from the server (/js/keycloak.js is gone) and the
// npm package is ES-module only, so the file is checked in as-is and imported by js/auth.js. Do not edit; to upgrade,
// copy node_modules/keycloak-js/lib/keycloak.js over this file and update the version above.
// @ts-check
/**
