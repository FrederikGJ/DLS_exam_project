...
/**
 * Declares the messaging topology used by flight-service:
 * <pre>
 *  airport.events (topic)  --booking.#-->  flight-service.booking-events
 *                                            | (rejected after 3 attempts)
 *                                            v
 *  airport.events.dlx (direct) --flight-service--> flight-service.dlq
 * </pre>
 */
@Configuration
