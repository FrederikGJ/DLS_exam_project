...
/**
 * Listens on the "booking.#" queue. Parses the envelope and hands it to the transactional handler.
 * Failures are retried (3 attempts, see application.yml) and then dead-lettered to payment-service.dlq.
 */
@Component
